      ...
      <div className="result-scroll">
        ...
        {mode === "plus" && (
          <div className="plus-block">
            ...
            <p className="explain">
              Comparamos o valor cobrado com {alternatives.length} ofertas de produtos equivalentes
              encontradas agora na web.
              {v.tone === "bad" &&
              ...
              return (
                <div className="alt-card" key={i}>
                  ...
                  <div className="alt-foot">
                    <span>{a.seller || "fonte não especificada"}</span>
                    {a.permalink ? (
                      <a href={a.permalink} target="_blank" rel="noreferrer">
                        Ver oferta →
                      </a>
                    ) : (
                      <span style={{ color: "var(--neutral)" }}>sem link direto</span>
                    )}
                  </div>
                  {savings > 0 && (
